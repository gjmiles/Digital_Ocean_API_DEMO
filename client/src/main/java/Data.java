...
public class Data {
    ...
    {	
	String rest_api_ip = "localhost:8080";
	String rest_api_url = "http://" + rest_api_ip + "/download_manager/GetImageServlet?name=" + this.fileName;
	...
	try{
	    ...
	    File save_file =  new File(this.fileName.toString());
